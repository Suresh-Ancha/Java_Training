...
public class Main {
	...
	public static void main(String[] args) {
		...
		while (!exit) {
			...
			System.out.println("6. Display rented vehicles");
	...
	private static void addVehicle(Scanner scanner) {
		...
		case 3:
			...
			System.out.print("Enter the model: ");
			model = scanner.next();
			vehicle = new Bicycle(make, model);
			break;
		default:
	...
	private static void displayRentedVehicles(Scanner scanner) {
		System.out.println();
